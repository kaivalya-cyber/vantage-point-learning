-- Temporarily drop foreign key constraints to insert sample data
ALTER TABLE public.questions DROP CONSTRAINT IF EXISTS questions_asker_id_fkey;
ALTER TABLE public.question_answers DROP CONSTRAINT IF EXISTS question_answers_answerer_id_fkey;
